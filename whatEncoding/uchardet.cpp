...
#ifdef _WIN64
#ifdef _DEBUG
#pragma comment(lib,"../x64/Debug/uCharDetDll.lib")
#else
#pragma comment(lib,"../x64/release/uCharDetDll.lib")
#endif
#else
#ifdef _DEBUG
#pragma comment(lib,"../Debug/uCharDetDll.lib")
#else
#pragma comment(lib,"../release/UchardetDll.lib")
#endif
#endif
...
{
    static struct option_a longopts[] =
    {
    ...
    static int oc;
    while((oc = getopt_long_a(argc, argv, "vh", longopts, NULL)) != -1)
    {
        switch (oc)
        {
        case 'v':
