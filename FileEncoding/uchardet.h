 ...
 */
DLL_EXPORTS uchardet_t  uchardet_new(void);

/**
 * Delete an encoding detector.
 * @param ud [in] handle of a instance of uchardet
 */
DLL_EXPORTS void  uchardet_delete(uchardet_t ud);
 ...
 */
DLL_EXPORTS int  uchardet_handle_data(uchardet_t ud, const char * data, size_t len);

/**
 * Notify an end of data to an encoding detctor.
 * @param ud [in] handle of a instance of uchardet
 */
DLL_EXPORTS void  uchardet_data_end(uchardet_t ud);

/**
 * Reset an encoding detector.
 * @param ud [in] handle of a instance of uchardet
 */
DLL_EXPORTS void  uchardet_reset(uchardet_t ud);
 ...
 */
DLL_EXPORTS const char *  uchardet_get_charset(uchardet_t ud);
